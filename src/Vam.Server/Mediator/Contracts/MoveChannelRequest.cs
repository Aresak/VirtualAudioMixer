...
/// <remarks>From and to rather than a whole order, so two consoles reordering at once cannot each send the list
/// they started from and silently undo each other.</remarks>
