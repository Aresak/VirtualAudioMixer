...
/// <remarks>By identifier, never by position. The audio thread reads by ordinal because that is fast; configuration
/// reads by name because that is stable.</remarks>
...
public sealed record SetModifierParameterRequest(
    ChainTarget Target,
    int LinkIndex,
    string ParameterId,
    double Value
