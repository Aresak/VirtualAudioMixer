...
/// <remarks>The role decides exactly three behaviours - its default send tap, whether it obeys solo, and whether it
/// needs an output device - so changing it is one command rather than rebuilding the bus.</remarks>
