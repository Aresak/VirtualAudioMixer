...
/// <remarks>Both halves together, always. A bus whose configuration changed without its thread being re-opened
/// keeps playing to the device it used to have, which is worse than silence.</remarks>
