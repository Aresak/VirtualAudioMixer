...
/// <remarks>In place rather than by rebuilding it: a strip carries its sends, its chain and its name, and none of
/// that should be lost because a microphone came back on a different endpoint.</remarks>
