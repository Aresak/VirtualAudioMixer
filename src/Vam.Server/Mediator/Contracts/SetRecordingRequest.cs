...
/// <remarks>A refusal carries the disk's own words: \"there is room for forty minutes\" is something an operator
/// can act on before a meeting, and \"recording failed\" is not.</remarks>
